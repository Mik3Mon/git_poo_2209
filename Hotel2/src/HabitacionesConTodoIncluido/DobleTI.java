 ...
 * @author dmathews
 */
public class DobleTI extends Doble {
    ...
    public DobleTI(String servicioALaHbitacion, String accesoAlRestauranteBar, String accesoALosConciertosYEspectaculos, String pulseraParaBarraLibre24Hrs, String dosCamasMatrimoniales, float precio, String horariosDeEntrada, String horariosDeSalida, float tarifasPorNoche) {
        super(dosCamasMatrimoniales, precio, horariosDeEntrada, horariosDeSalida, tarifasPorNoche);
