 ...
 * @author dmathews
 */
public class PresidencialTI extends Presidencial {
    ...
    public PresidencialTI() {
    }

    public PresidencialTI(String servicioALaHbitacion, String accesoAlRestauranteBar, String accesoALosConciertosYEspectaculos, String pulseraParaBarraLibre24Hrs, String recibidor, String sala, String bar, String alberca, String dosCamasKingSize, float precio, String horariosDeEntrada, String horariosDeSalida, float tarifasPorNoche) {
        super(recibidor, sala, bar, alberca, dosCamasKingSize, precio, horariosDeEntrada, horariosDeSalida, tarifasPorNoche);
